...
public class ConfiguracionCuenta {
    ...
    private ArrayList<String> preferencias;//si no se logra enviar el Array desde angular hacia aquí, tendrá que pasarse a un String[]
    
    private String tipo = "Configuracion_Cuenta";

    public ConfiguracionCuenta(int IDUsuario, String tema, String fotoPerfil, String portada, ArrayList<String> preferencias) {
