...
ALTER TABLE Autor ADD FOREIGN KEY(IDUsuario) REFERENCES Usuario(ID) ON DELETE NO ACTION;
...
ALTER TABLE Libro ADD FOREIGN KEY(IDautor) REFERENCES Autor(IDUsuario) ON DELETE NO ACTION;
...
ALTER TABLE AutorSeguido ADD FOREIGN KEY(IDSeguidor) REFERENCES Usuario(ID) ON DELETE CASCADE;
ALTER TABLE AutorSeguido ADD FOREIGN KEY(IDAutor) REFERENCES Autor(IDUsuario) ON DELETE CASCADE;
...
ALTER TABLE LibroAdquirido ADD FOREIGN KEY(IDUsuario) REFERENCES Usuario(ID) ON DELETE CASCADE;
...
fotoPerfil TEXT,
portada TEXT,
preferencias varchar(2000) DEFAULT 'Ninguna'
);
ALTER TABLE Configuracion ADD FOREIGN KEY(IDUsuario) REFERENCES Usuario(ID) ON DELETE CASCADE;
...
ALTER TABLE Noticia ADD FOREIGN KEY(IDCreador) REFERENCES Autor(IDUsuario) ON DELETE NO ACTION;
